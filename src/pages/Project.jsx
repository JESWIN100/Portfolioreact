      ...
      <Container>
        <Card style={{ width: '' }}>
          ...
          <Card.Body>
            ...
            <Button href='https://jeswin100.github.io/Portfolio_Validated/Screenshot%202024-01-31%20091237.png' variant="primary">Go somewhere</Button>
          </Card.Body>
        </Card>
        ...
        <Card style={{ margin: '10px' }}>
          ...
          <Card.Body>
            ...
            <Button href='https://jeswin100.github.io/Portfolio_Validated/Screenshot%202023-09-15%20220604.png' variant="primary">Go somewhere</Button>
          </Card.Body>
          ...
          <Card.Body>
            ...
            <Button href={twitter} >Go somewhere</Button>
          </Card.Body>
        </Card>
      </Container>
    </div>
